...
function EggProductionReport() {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const response = await axios.get(
                    `${process.env.REACT_APP_API_URL}/api/daily_production/report/${localStorage.getItem('farmId')}?StartDate=${reportData.startDate}&EndDate=${reportData.endDate}`,
                    {
    ...
    const chartOptions = {
        data: chartData,
        title: {
            text: `Egg Production - Batch ${selectedBatch}`,
            fontSize: 16,
        },
        series: [
            {
    ...
    return (
        <div className="container mt-5 pt-5">
            <Breadcrumb>
                ...
                <Breadcrumb.Item active>Egg Production</Breadcrumb.Item>
            </Breadcrumb>
            <div className="row">
...
export default EggProductionReport;
