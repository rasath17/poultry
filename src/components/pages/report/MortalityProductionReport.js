...
function MortalityReport() {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const response = await axios.get(
                    `${process.env.REACT_APP_API_URL}/api/mortalities/report/${localStorage.getItem('farmId')}?StartDate=${reportData.startDate}&EndDate=${reportData.endDate}`,
                    {
                ...
                console.error("Error fetching mortality data:", error.message);
            }
        };
    ...
    const chartOptions = {
        data: chartData,
        title: {
            text: `Mortality Report - Batch ${selectedBatch}`,
            fontSize: 16,
        },
        series: [
            {
    ...
    return (
        <div className="container mt-5 pt-5">
            <Breadcrumb>
                ...
                <Breadcrumb.Item active>Mortality Report</Breadcrumb.Item>
            </Breadcrumb>
            <div className="row">
